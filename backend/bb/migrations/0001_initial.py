    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cpf', models.CharField(max_length=11, unique=True, validators=[bb.utils.validators.validate_cpf])),
                ('banco', models.CharField(max_length=100)),
                ('agencia', models.CharField(max_length=20)),
                ('conta', models.CharField(max_length=20)),
                ('conta_titular', models.CharField(max_length=100)),
                ('cnpj', models.CharField(max_length=14, validators=[bb.utils.validators.validate_cnpj])),
            ],
        ),
        migrations.CreateModel(
            name='Pessoa',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estabelecimento', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='bb.Estabelecimento')),
                ('tipo', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='bb.MaquinaTipo')),
            ],
        ),
        migrations.CreateModel(
            name='Exame',
            fields=[
                ...
                ('estabelecimento', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='bb.Estabelecimento')),
                ('maquina', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='bb.Maquina')),
                ('orientador', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='bb.Orientador')),
                ('pessoa', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='bb.Pessoa')),
            ],
        ),
        migrations.CreateModel(
            name='BiobodyUser',
